...
| [MCP Architecture](mcp_architecture.md) | Model Context Protocol integration and standard IDE support | Both |
...
| [Troubleshooting MCP](troubleshooting_mcp.md) | Fixing JSONRPC connection and configuration issues |
