...
def test_refactoring_completion():
    ...
    import os
    readme_files = ['../ufo/galaxy/README.md', '../ufo/galaxy/visualization/README.md', '../ufo/galaxy/session/README.md']
    ...
    print('✅ Legacy handlers (task_visualization_handler.py, constellation_visualization_handler.py) deprecated')
