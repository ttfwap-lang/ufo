...
class TestConstellationStrategyFactory:
    ...
    def test_get_all_strategies_creation_mode(self):
        ...
        assert ProcessingPhase.LLM_INTERACTION.value in strategies
        assert ProcessingPhase.ACTION_EXECUTION.value in strategies
        assert isinstance(
            strategies[ProcessingPhase.LLM_INTERACTION.value],
            ConstellationCreationLLMInteractionStrategy,
        )
        assert isinstance(
            strategies[ProcessingPhase.ACTION_EXECUTION.value],
            ConstellationCreationActionExecutionStrategy,
        )
...
class TestPrompterBehaviorDifferentiation:
    ...
    def test_creation_vs_editing_prompters_different_behavior(self):
        ...
        assert hasattr(creation_prompter, "prompt_construction")
        assert hasattr(editing_prompter, "prompt_construction")
