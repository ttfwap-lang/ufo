...
class TestAgentPresenterIntegration(unittest.TestCase):
    ...
    def test_list_action_command_info_color_print(self, mock_console_class):
        ...
        action1.function = 'click'
        action1.arguments = {'x': 100, 'y': 200}
        action1.target = None
        ...
        action2.function = 'click'
        action2.arguments = {'x': 300, 'y': 400}
        action2.target = None
...
class TestPresenterOutputConsistency(unittest.TestCase):
    ...
    def test_constellation_operation_formatting(self, mock_console_class):
        ...
        test_cases = [{'function': 'add_task', 'arguments': {'task_id': 'task-1', 'name': 'Test'}, 'expected_substring': 'Add Task'}, {'function': 'remove_task', 'arguments': {'task_id': 'task-1'}, 'expected_substring': 'Remove Task'}, {'function': 'add_dependency', 'arguments': {'dependency_id': 'dep-1', 'from_task_id': 'task-1', 'to_task_id': 'task-2'}, 'expected_substring': 'Add Dependency'}]
