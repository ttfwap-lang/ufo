...
async def test_constellation_events():
    ...
    event_bus.subscribe(observer=event_collector, event_types={EventType.CONSTELLATION_STARTED, EventType.CONSTELLATION_COMPLETED})
    ...
    task1 = TaskStar(task_id='task_1', name='First Task', description='Execute first task', target_device_id='device_1', task_data={'command': "echo 'Task 1'"})
    task2 = TaskStar(task_id='task_2', name='Second Task', description='Execute second task', target_device_id='device_2', task_data={'command': "echo 'Task 2'"})
    constellation.add_task(task1)
    constellation.add_task(task2)
    dependency = TaskStarLine(from_task_id='task_1', to_task_id='task_2', condition_description='Task 1 must complete first')
    ...
    try:
        ...
        expected_events = [EventType.CONSTELLATION_STARTED, EventType.CONSTELLATION_COMPLETED]
