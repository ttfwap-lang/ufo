...
def test_basic_json_operations():
    ...
    print('=' * 60)
    try:
        task = TaskStar(name='Simple Test Task', description='A simple task for testing JSON operations', tips=['Be careful', 'Test thoroughly'], timeout=300.0, retry_count=2)
...
def test_task_star_line_basic():
    ...
    print('=' * 60)
    try:
        line = TaskStarLine(from_task_id='task_001', to_task_id='task_002', dependency_type=DependencyType.UNCONDITIONAL, condition_description='Simple unconditional dependency')
