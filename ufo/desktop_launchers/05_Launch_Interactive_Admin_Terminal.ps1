...
$action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-NoExit -Command \"cd C:\Users\lnxzf\Desktop\projects\ufo\ufo; Write-Host 'UFO Desktop Terminal - Full Access';\""
