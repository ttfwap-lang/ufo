...
def create_fallback_omniparser_mcp_server(*args, **kwargs) -> FastMCP:
    ...
    def parse_screen_pixels() -> str:
        ...
        try:
            ...
            raise ToolError(f'OmniParser is not configured. Set OMNIPARSER.ENDPOINT in config/ufo/system.yaml to use pixel-based parsing. Error: {e}')
        ...
        try:
            ...
            raise ToolError(f'OmniParser pixel parsing failed. Ensure the OmniParser service is running at {endpoint}. Error: {e}')
    return mcp
