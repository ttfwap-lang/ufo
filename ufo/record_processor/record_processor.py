...
def main():
    ...
    try:
        ...
        app_agent_cfg = configs.get("APP_AGENT", {}) if hasattr(configs, "get") else {}

        summarizer = DemonstrationSummarizer(
            app_agent_cfg.get("VISUAL_MODE", configs.get("VISUAL_MODE", True)),
            configs.get("DEMONSTRATION_PROMPT", ""),
            app_agent_cfg.get("EXAMPLE_PROMPT", configs.get("APPAGENT_EXAMPLE_PROMPT", configs.get("appagent_example_prompt", ""))),
            app_agent_cfg.get("API_PROMPT", configs.get("API_PROMPT", configs.get("api_prompt", ""))),
            configs.get("RAG_DEMONSTRATION_COMPLETION_N", 1),
        )
