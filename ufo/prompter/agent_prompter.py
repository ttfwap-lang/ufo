...
class AppAgentPrompter(BasicPrompter):
    ...
    def user_prompt_construction(
        ...
        prompt = user_template.format(
            ...
            host_message=json.dumps(host_message, separators=(",", ":")),
            retrieved_docs=sanitize_user_input(retrieved_docs, "retrieved_docs"),
            last_success_actions=json.dumps(last_success_actions, separators=(",", ":")),
        )
    ...
    def examples_prompt_helper(
        ...
        if additional_examples is None:
            ...
            additional_examples = copy.deepcopy(additional_examples)
        ...
        if ufo_config.system.action_sequence:
            ...
            for example in additional_examples:
                ...
                ex_copy["Response"] = self.action2action_sequence(
                    ex_copy.get("Response", {})
                )
