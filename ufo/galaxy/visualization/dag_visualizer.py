                ...
                if deps:
                    ...
                    for dep in deps:
                        ...
                        if dep_task:
                            ...
                            condition_desc = getattr(dep, "condition_description", None)
                            if condition_desc:
        ...
        for dep_type, deps in dep_by_type.items():
            ...
            for dep in deps[:10]:  # Limit to first 10 for readability
                ...
                if from_task and to_task:
                    ...
                    # Status indicators
                    from_status = self.task_display.get_task_status_icon(from_task.status)
                    to_status = self.task_display.get_task_status_icon(to_task.status)
