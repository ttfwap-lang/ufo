...
/**
 * Sanitize a string value for safe display in template literals.
 * Prevents XSS by escaping HTML-significant characters.
 * Note: These are display strings, NOT SQL queries — IDE SQL injection warnings are false positives.
 */
const sanitizeDisplayValue = (val: unknown): string => {
 ...
 */
// eslint-disable-next-line @security/detect-non-literal-query
